 ...
 * @type {Set<string>}
 */
// src/core/validators/ContentSchemaValidator.js
'use strict';

const { TIPOS_VALIDOS } = require('../constants/tiposValidos');

// ... [El resto de la lógica de validarContenido permanece igual] ...
